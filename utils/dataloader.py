...
import torch.utils.data.sampler as tsample

def traindata(kwargs,args,input_size,valid_percentage,dataset,limiteddata=False):
    if dataset == 'mnist':
        ...
        root = '/home/hojjat/ising/data/fashion/images/train'  
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])),
                # transforms.RandomResizedCrop(input_size[1]),
                transforms.Grayscale(),
        ...
        root = '/home/hojjat/ising/data/kuzushiji/images/train'  
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])),
                transforms.Grayscale(),
                # transforms.RandomHorizontalFlip(),
        ...
        root = '/home/hojjat/ising/data/flowers/images/train'
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])),
                transforms.RandomHorizontalFlip(),
        ...
        root = '/home/hojjat/ising/data/cifar10/images/train'
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])),
        ...
        root = '/home/hojjat/ising/data/cifar100/images/train'
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])),
                transforms.RandomCrop(32, padding=4),
                transforms.RandomHorizontalFlip(),
    ...
    if limiteddata: 
        train_loader = torch.utils.data.DataLoader(subsetTrain,
                                                    ...
                                                    num_workers=4,sampler=tsample.SubsetRandomSampler(np.arange(1000)))
    else:
        train_loader = torch.utils.data.DataLoader(subsetTrain,
...
def testdata(kwargs,args,input_size,dataset):
    if dataset == 'mnist':
        ...
        root = '/home/hojjat/ising/data/fashion/images/test'        
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])),
                transforms.Grayscale(),
                transforms.ToTensor(),
        ...
        root = '/home/hojjat/ising/data/kuzushiji/images/test'  
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])),
                transforms.Grayscale(),
                # transforms.RandomHorizontalFlip(),
        ...
        root = '/home/hojjat/ising/data/flowers/images/test'
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])),
                transforms.ToTensor(),
                # transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))
        ...
        root = '/home/hojjat/ising/data/cifar10/images/test'
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])), 
                transforms.ToTensor(),
                # transforms.Normalize((0.,), (1.,))
        ...
        root = '/home/hojjat/ising/data/cifar100/images/test'
        data_transform = transforms.Compose([
                transforms.Resize((input_size[1],input_size[2])),
                # transforms.RandomHorizontalFlip(),
                # transforms.RandomRotation((0,180), resample=False, expand=False, center=None, fill=0),
